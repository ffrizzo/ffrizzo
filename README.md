...
- [WalletConnect/walletconnect-monorepo @ 2.3.3](https://github.com/WalletConnect/walletconnect-monorepo/releases/tag/2.3.3) (4 days ago)
- [surrealdb/surrealdb @ v1.0.0-beta.8](https://github.com/surrealdb/surrealdb/releases/tag/v1.0.0-beta.8) (4 months ago)

#### ⭐ Recent Stars


- **[ucan-wg/awake](https://github.com/ucan-wg/awake)** - AWAKE Protocol Specification (3 days ago)
- **[henvic/httpretty](https://github.com/henvic/httpretty)** - Package httpretty prints the HTTP requests you make with Go pretty on your terminal. (3 days ago)
